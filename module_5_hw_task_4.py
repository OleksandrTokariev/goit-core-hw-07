...
def input_error_add_contact(func):
    def inner(*args, **kwargs):
        try:
            ...
            return "Please enter the name and phone number after the 'add' command."
    return inner
...
def input_error_change_contact(func):
    def inner(*args, **kwargs):
        try:
            ...
            return "Please enter the name and phone number after the 'change' command."
    return inner
...
def input_error_show_phone_number(func):
    def inner(*args, **kwargs):
        try:
            return func(*args, **kwargs)
        except IndexError:
